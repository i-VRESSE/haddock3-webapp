 ...
 */
export function instanceOfInteractiveApplicationConfiguration(
  value: object
): boolean {
  let isInstance = true;
...
export function InteractiveApplicationConfigurationFromJSON(
  json: any
): InteractiveApplicationConfiguration {
  return InteractiveApplicationConfigurationFromJSONTyped(json, false);
}

export function InteractiveApplicationConfigurationFromJSONTyped(
  json: any,
...
export function InteractiveApplicationConfigurationToJSON(
  value?: InteractiveApplicationConfiguration | null
): any {
  if (value === undefined) {
    return undefined;
  }
