...
export function ApplicatonConfigurationFromJSON(
  json: any
): ApplicatonConfiguration {
  return ApplicatonConfigurationFromJSONTyped(json, false);
}

export function ApplicatonConfigurationFromJSONTyped(
  json: any,
  ...
  return {
    ...
    config: json["config"],
    allowedRoles: !exists(json, "allowed_roles")
      ? undefined
      : json["allowed_roles"],
  };
}

export function ApplicatonConfigurationToJSON(
  value?: ApplicatonConfiguration | null
): any {
  if (value === undefined) {
    return undefined;
  }
