...
export class ApplicationApi extends runtime.BaseAPI {
     ...
     * Get Application
     */
    async getApplicationRaw(requestParameters: GetApplicationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApplicatonConfiguration>> {
     ...
     * Get Application
     */
    async getApplication(requestParameters: GetApplicationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApplicatonConfiguration> {
     ...
     * List Applications
     */
    async listApplicationsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<string>>> {
        const queryParameters: any = {};
     ...
     * List Applications
     */
    async listApplications(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<string>> {
     ...
     * Upload Job
     */
    async uploadJobRaw(requestParameters: UploadJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.application === null || requestParameters.application === undefined) {
            throw new runtime.RequiredError('application','Required parameter requestParameters.application was null or undefined when calling uploadJob.');
        }

        if (requestParameters.upload === null || requestParameters.upload === undefined) {
            throw new runtime.RequiredError('upload','Required parameter requestParameters.upload was null or undefined when calling uploadJob.');
        }
     ...
     * Upload Job
     */
    async uploadJob(requestParameters: UploadJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
