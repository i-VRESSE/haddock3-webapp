...
export class RolesApi extends runtime.BaseAPI {
     ...
     * Assign Role To User
     */
    async assignRoleToUserRaw(requestParameters: AssignRoleToUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<string>>> {
        if (requestParameters.roleId === null || requestParameters.roleId === undefined) {
            throw new runtime.RequiredError('roleId','Required parameter requestParameters.roleId was null or undefined when calling assignRoleToUser.');
        }

        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling assignRoleToUser.');
        }
     ...
     * Assign Role To User
     */
    async assignRoleToUser(requestParameters: AssignRoleToUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<string>> {
     ...
     */
    async unassignRoleFromUserRaw(requestParameters: UnassignRoleFromUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<string>>> {
        if (requestParameters.roleId === null || requestParameters.roleId === undefined) {
            throw new runtime.RequiredError('roleId','Required parameter requestParameters.roleId was null or undefined when calling unassignRoleFromUser.');
        }

        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling unassignRoleFromUser.');
        }
     ...
     * Unassign Role From User
     */
    async unassignRoleFromUser(requestParameters: UnassignRoleFromUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<string>> {
        const response = await this.unassignRoleFromUserRaw(requestParameters, initOverrides);
        return await response.value();
    }
